...
const plans = [
    {
        name: "Hobby",
        description:
            "Perfect for individuals exploring AI-assisted coding and local models",
        price: 0,
        yearlyPrice: 0,
    ...
    },
    {
        name: "Pro",
        description:
            "For professional developers who need maximum speed and capabilities",
        price: 20,
        yearlyPrice: 190,
        buttonText: "Get Pro",
    ...
    },
    {
        name: "Team",
        description:
            "For teams requiring shared context, security, and centralized billing",
        price: 50,
        yearlyPrice: 480,
      ...
      `,
            ...
            <div className="grid md:grid-cols-3 max-w-5xl gap-4 py-6 mx-auto ">
                {plans.map((plan, index) => (
                    ...
                    >
                        <Card
                            className={`relative text-white border-neutral-800 ${plan.popular
